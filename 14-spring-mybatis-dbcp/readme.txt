14-spring-mybatis-dbcp：spring整合mybatis,使用dbcp连接池
...
2.导入jar:
  ...
  5)其他的jar: mysql的驱动， 日志 commons-logging.jar , log4j.jar, junit.jar
  6)dbcp连接池： commons-dbcp.jar, commons-pool.jar
